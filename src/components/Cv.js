        ...
        <div className="sidebar-wrapper">
            ...
            <div className="contact-container container-block">
                <ul className="list-unstyled contact-list">
                    ...
                    <li className="linkedin"><i className="fab fa-linkedin-in"></i><a href="/" >linkedin.com/in/alandoe</a></li>
                    <li className="github"><i className="fab fa-github"></i><a href="/">github.com/username</a></li>
                    <li className="twitter"><i className="fab fa-twitter"></i><a href="https://twitter.com/3rdwave_themes" >@twittername</a></li>
                </ul>target="_blank"
            </div>
